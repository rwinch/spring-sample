...
public abstract class AbstractSecurityDsl implements BeanRegistrar {

    public abstract void register(HttpSecurity http);
    ...
    public void register(BeanRegistry registry, Environment env) {
        ...
        securityFilters.add(exceptionTranslationFilter(http));
        securityFilters.add(authorizationFilter(http));
    ...
    private AuthorizationFilter authorizationFilter(HttpSecurity http) {
        ...
        return new AuthorizationFilter(builder.build());
    }
